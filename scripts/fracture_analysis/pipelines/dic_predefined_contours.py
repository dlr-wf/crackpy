"""Run crack detection and fracture analysis with predefined integration contours."""
...
# Input: DIC nodemaps from the repository crack-detection test data.
# Output: crack-detection data, fracture-analysis results, and aggregate CSV files.
