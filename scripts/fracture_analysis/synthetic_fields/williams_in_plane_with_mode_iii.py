...
def main():
    ...
    terms = [1, 2]
    disp_u_mesh, disp_v_mesh = williams_in_plane_displacement_field(A, B, terms, phi_grid, r_grid, material)
    disp_w_mesh = williams_out_of_plane_displacement_field(C, terms, phi_grid, r_grid, material)
